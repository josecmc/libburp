...
rm -rf core *.o *.a *.so libburp_c.a libburp_c_shared.so
...
#s.compile -o libburp_c_shared.so -src burp_api.c $compiler_parameters -shared -obj /ssm/net/rpn/libs/15.2/aix-7.1-ppc7-64/lib/AIX-powerpc7/xlf13/librmnshared_015.2.so
