...
int main ( int argc, char * argv[] ) 
{
    ...
    BLK_SetSTORE_TYPE( br, STORE_FLOAT );
    ...
    BLK_SetRVAL( br, 0,0,0, 10.0 ); // pour 7004
    BLK_SetRVAL( br, 1,0,0, 20.0 ); // pour 11001
